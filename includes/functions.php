...
function countdowncdt_get_custom_color() {
    ...
    $day_bg_color_style_two  = $color_tab['day_bg_color_style_two'];
    $hour_bg_color_style_two = $color_tab['hour_bg_color_style_two'];
    $min_bg_color_style_two  = $color_tab['min_bg_color_style_two'];
    $sec_bg_color_style_two  = $color_tab['sec_bg_color_style_two'];
